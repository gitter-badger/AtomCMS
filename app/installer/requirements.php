...
/**
 * This class specifies all Atomcms requirements and optional recommendations.
 *
 * @author Tobias Schultze <http://tobion.de>
 * @author Fabien Potencier <fabien@symfony.com>
 */
class AtomcmsRequirements extends RequirementCollection
{
    ...
    public function __construct($path)
    {
        ...
        $this->addRequirement(
            ...
            sprintf('You are running PHP version "<strong>%s</strong>", but Atomcms needs at least PHP "<strong>%s</strong>" to run.
                Before using Atomcms, upgrade your PHP installation, preferably to the latest version.',
...
return new AtomcmsRequirements($path);
